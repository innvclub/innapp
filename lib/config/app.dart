...
class Config {
  ...
  /// Generated by SiteNative 15-11-2022 03:56:11
  /// App UID: b54cbe22-d1a8-8229-70c3-5e1efbb15247
  /// Version: https://app.innv.club/backend/
  /// API server: {VERSION}

  /// *** App config *** ///
  // App name
  static String appName = "Themes  Club";
  // App link
  static String appLink = "https://themes-club.com/";
  // Display page name without app name (after 1 page)
  static bool displayTitle = true;
  // Main color (any HEX color)
  static String color = "#6417A5";
  // Active color (any HEX color)
  static String activeColor = "#6417A5";
  // Icon color color (any HEX color)
  static String iconColor = "#6417A5";
  ...
  static String indicatorColor = "#6417A5";
  ...
  static String drawerBackgroundColor = "#6417A5";
  // Title color (true - white, false - black)
  ...
  // Background color (any HEX color)
  static String splashBackgroundColor = "#6417A5";
  ...
  // Signing
  static String osSigning = "33ceb9ec85da604fda467a92dd3af37fbe60a5980e16969635778119de767635";
  // Enabled android?
