...
class Config {
  ...
  /// Generated by SiteNative 15-11-2022 01:47:11
  /// App UID: d541fe8e-d0c6-b3d3-2081-d6e211003a26
  /// Version: https://app.innv.club/backend/
  /// API server: {VERSION}

  /// *** App config *** ///
  // App name
  static String appName = "nmnkj";
  // App link
  ...
  // Signing
  static String osSigning = "bba24e514f92282f6b8ab523b37e2e6d62a47aa7ea9990950b008ea12193eb5e";
  // Enabled android?
  ...
  static List<NavigationItem> mainNavigation = [
    	NavigationItem(name: "ADS",icon: "albums-outline.svg",type: ActionType.internal,value: "https://app.innv.club/",),
