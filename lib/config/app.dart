...
class Config {
  ...
  /// Generated by SiteNative 16-11-2022 02:53:03
  /// App UID: 6fb16ecd-e16b-a7c7-1786-3f096f9a6499
  /// Version: https://app.innv.club/backend/
  /// API server: {VERSION}

  /// *** App config *** ///
  // App name
  static String appName = "Abbas Innovations";
  // App link
  ...
  // Signing
  static String osSigning = "2ba16bcc18c42e4551f5a6d4170885ed13ef27c03cc8cf11b65fd56869d4ff90";
  // Enabled android?
  ...
  static List<NavigationItem> mainNavigation = [
    	NavigationItem(name: "صمم متجرك",icon: "cart-outline.svg",type: ActionType.internal,value: "https://abbasinnovations.com/ar/create-your-store/",),
	NavigationItem(name: "صمم موقعك",icon: "desktop-outline.svg",type: ActionType.internal,value: "https://abbasinnovations.com/ar/create-your-website/",),
	NavigationItem(name: "تواصل معنا",icon: "logo-whatsapp.svg",type: ActionType.internal,value: "https://wa.me/+201025676190",),
